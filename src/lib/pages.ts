...
export const pages: Record<string, PageSpec> = {
  "peer-advisory-groups": {
    ...
    faqs: [
      ...
      { q: "How much do the peer advisory groups cost?", a: "Pricing varies between John's and Jim's groups depending on the cohort, format, and season. Request a fit conversation and we'll share current rates and walk you through which group is the right fit for you." },
